...
def tax_agent_orchestrator(inp: str):
    """AGENT Orchestrator"""
...
def test_case():
    ...
    response = tax_agent_orchestrator("what is the tax M&E adjustment for entity 1000 ?")
    ...
    response = tax_agent_orchestrator("Is my user account eligible for the Responses API?")
    final_answer = extract_final_answer_from_chat_result(response)
    print("Final Answer:", final_answer)
